...
const TakePicture = () => {
  ...
  useEffect(() => {
    let isMounted = true; // untuk menghindari update state di komponen yang sudah unmount
    ...
    <div className="min-h-screen bg-gray-50 p-4 flex flex-col items-center">
      <div className="w-full max-w-3xl">
        ...
        <div className="flex items-center justify-between mb-6">
          <button onClick={handleCancel} className="flex items-center space-x-2 text-green-600 hover:text-green-700 transition-colors">
            <ArrowLeft size={24} />
        ...
        {errorMsg ? (
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <video ref={videoRef} autoPlay muted playsInline className="w-full h-auto rounded-lg shadow-md mb-6 object-cover" />
