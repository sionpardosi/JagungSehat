                    ...
                    <div className="hidden lg:flex w-1/2 bg-green-600 text-white p-12 flex-col justify-center">
                        ...
                        <div className="mt-8">
                            <div className="flex items-center space-x-3 mb-4">
                                ...
                                <span className="text-green-100 text-sm">Gratis untuk semua petani</span>
                            </div>
                            <div className="flex items-center space-x-3 mb-4">
                                <div className="w-2 h-2 bg-green-300 rounded-full"></div>
                                <span className="text-green-100 text-sm">Akses tak terbatas ke deteksi AI</span>
                            </div>
                            <div className="flex items-center space-x-3">
                                <div className="w-2 h-2 bg-green-300 rounded-full"></div>
                                <span className="text-green-100 text-sm">Dukungan komunitas petani</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full lg:w-1/2 p-8 lg:p-12">
                        <div className="max-w-sm mx-auto">
                            ...
                            <div className="lg:hidden mt-8 text-center">
                                <p className="text-gray-600 text-sm">
                                    Bergabunglah dengan komunitas petani yang menggunakan teknologi AI untuk hasil panen yang optimal
                                </p>
                            </div>
                        </div>
                    </div>
